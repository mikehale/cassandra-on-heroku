...
sdb.delete_domain("InstanceProperty")
...
sdb.put_attributes("PriamProperties", "cassandra/priam.cass.startscript", {"appId" => "cassandra", "property" => "priam.cass.startscript", "value" => "service cassandra-cassandra start || true"})
